...
const ClientSuccess = () => {
  return (
    <div className="max-w-[1440px] mx-auto font mt-[14px]  px-5 xl:px-10 ">
      ...
      >
        ...
        <p className="font-medium text-[16px] sm:text-[18px] text-[#A7ADBE] text-center max-w-[720px]  px-2 sm:px-0 ">
